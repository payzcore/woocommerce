	...
	<div class="notice notice-error">
		<p>
			...
			printf(
				...
				esc_html__( '%s requires WooCommerce to be installed and active.', 'payzcore' ),
 ...
 * @return void
 */
function payzcore_load_textdomain() {
	load_plugin_textdomain( 'payzcore', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
}
add_action( 'init', 'payzcore_load_textdomain' );
