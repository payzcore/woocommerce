 ...
 * @var string $chain            Blockchain network (TRC20, BEP20, ERC20, POLYGON, ARBITRUM).
...
$network_labels = array(
	'TRC20'    => __( 'TRC20 (Tron)', 'payzcore' ),
	'BEP20'    => __( 'BEP20 (BNB Smart Chain)', 'payzcore' ),
	'ERC20'    => __( 'ERC20 (Ethereum)', 'payzcore' ),
	'POLYGON'  => __( 'Polygon', 'payzcore' ),
	'ARBITRUM' => __( 'Arbitrum', 'payzcore' ),
);
$network_label = isset( $network_labels[ $chain ] ) ? $network_labels[ $chain ] : esc_html( $chain );
?>
		...
		<div class="payzcore-amount-section">
			...
			<div class="payzcore-amount-row">
				...
				<button type="button"
					...
					title="<?php esc_attr_e( 'Copy amount', 'payzcore' ); ?>">
		...
		<?php if ( ! empty( $qr_code ) ) : ?>
			<div class="payzcore-qr-section">
				<img
					...
					alt="<?php esc_attr_e( 'Payment QR Code', 'payzcore' ); ?>"
		...
		<div class="payzcore-address-section">
			...
			<div class="payzcore-address-row">
				...
				<button type="button"
					...
					title="<?php esc_attr_e( 'Copy address', 'payzcore' ); ?>">
					<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
						<rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
						<path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
					</svg>
