...
Tags: crypto, usdt, usdc, stablecoin, trc20, bep20, erc20, polygon, arbitrum, blockchain, woocommerce
...
PayzCore for WooCommerce enables your store to accept USDT (Tether) and USDC (USD Coin) stablecoin payments on multiple blockchain networks: TRC20 (Tron), BEP20 (BNB Smart Chain), ERC20 (Ethereum), Polygon, and Arbitrum.
...
* Multi-chain support: TRC20 (Tron), BEP20 (BNB Smart Chain), ERC20 (Ethereum), Polygon, and Arbitrum
...
* Backward compatible: existing installations default to current settings
...
= 1.0.0 =
* Initial release
* Multi-chain support: TRC20, BEP20, ERC20, Polygon, Arbitrum
* Multi-token support: USDT + USDC
* Chain/token selector on checkout page
